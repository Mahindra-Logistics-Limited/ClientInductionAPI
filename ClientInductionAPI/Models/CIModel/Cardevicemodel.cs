...
{
    [Keyless]
    [Table("CARDEVICEMODEL")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "CARDEVICEMODEL_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_CARDEVICEMODEL_PKGUID", IsUnique = true)]
    public partial class Cardevicemodel
    {
        [Required]
        [Column("GUID")]
        [StringLength(36)]
