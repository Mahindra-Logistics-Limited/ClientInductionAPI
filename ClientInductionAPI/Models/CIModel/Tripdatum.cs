...
{
    [Table("TRIPDATA")]
    [Index(nameof(Cabregistration), nameof(Tripendtime), Name = "TRIP_CAB_TRIP_DT")]
    [Index(nameof(Cabregistration), Name = "TRIP_DATA_CAB")]
    [Index(nameof(Jobid), Name = "TRIP_JOBID_IND")]
    [Index(nameof(Subscriberid), Name = "TRIP_SUBID_IND")]
    [Index(nameof(Subscriberid), nameof(Tripendtime), Name = "TRIP_SUBID_TRIP_DT")]
    public partial class Tripdatum
    {
        [Column("JOBID")]
        [StringLength(36)]
