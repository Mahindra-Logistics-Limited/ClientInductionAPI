...
{
    [Table("USERSETTING")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "USERSETTING_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_USERSETTING_PKGUID", IsUnique = true)]
    public partial class Usersetting
    {
        ...
        [Required]
        [Column("SYSTEMSETTINGGUID")]
        [StringLength(36)]
        public string Systemsettingguid { get; set; }
        [Required]
