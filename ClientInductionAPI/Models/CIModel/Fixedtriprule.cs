...
{
    [Keyless]
    [Table("FIXEDTRIPRULES")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "FIXEDTRIPRULES_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_FIXEDTRIPRULES_PKGUID", IsUnique = true)]
    public partial class Fixedtriprule
    {
        [Required]
        [Column("GUID")]
        [StringLength(36)]
        ...
        [Column("FIXED_UNIT")]
        [StringLength(20)]
        public string FixedUnit { get; set; }
    }
}
