...
{
    [Table("UPI_TXN_TABLE")]
    [Index(nameof(Appupdated), Name = "UPI_TXN_APPUPDATED")]
    [Index(nameof(Banktxnid), Name = "UPI_TXN_BANKTXNID")]
    [Index(nameof(Datecreated), Name = "UPI_TXN_DATECRREATED")]
    [Index(nameof(Pragatistatus), Name = "UPI_TXN_PRAGATISTATUS")]
    [Index(nameof(Pragatitxnid), Name = "UPI_TXN_PRAGATITXNID")]
    [Index(nameof(Site), Name = "UPI_TXN_SITE")]
    [Index(nameof(Spid), Name = "UPI_TXN_SPID")]
    [Index(nameof(Spnpcitxnid), Name = "UPI_TXN_SPNPCITXNID")]
    [Index(nameof(Spupdated), Name = "UPI_TXN_SPUPDATED")]
    public partial class UpiTxnTable
    {
        [Key]
