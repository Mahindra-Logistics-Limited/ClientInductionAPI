...
namespace ClientInductionAPI.Models.CIModel
{
    [Keyless]
    [Table("MENUMASTER")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "MENUMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_MENUMASTER_PKGUID", IsUnique = true)]
    public partial class Menumaster
    {
        ...
        [Column("MENULEVEL", TypeName = "NUMBER")]
