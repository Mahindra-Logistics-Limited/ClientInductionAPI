...
{
    [Keyless]
    [Table("ANSWERTYPEMAPPING")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "ANSWERTYPEMAPPING_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_ANSWERTYPEMAPPING_PKGUID", IsUnique = true)]
    public partial class Answertypemapping
    {
        [Column("GUID")]
        [StringLength(36)]
