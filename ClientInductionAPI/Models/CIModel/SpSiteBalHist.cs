...
{
    [Keyless]
    [Table("SP_SITE_BAL_HIST")]
    [Index(nameof(Siteguid), nameof(BalanceDt), Name = "XMERU_BAL_HIST_IND", IsUnique = true)]
    public partial class SpSiteBalHist
    {
        [Column("SITEGUID")]
        [StringLength(36)]
        ...
        [Column("PKGNONBALUPDATEAMOUNT_DR", TypeName = "NUMBER(12,2)")]
        public decimal? PkgnonbalupdateamountDr { get; set; }
        [Column("PKGNONBALUPDATEAMOUNT_CR", TypeName = "NUMBER(12,2)")]
        public decimal? PkgnonbalupdateamountCr { get; set; }
    }
}
