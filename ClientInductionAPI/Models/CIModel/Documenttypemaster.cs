...
namespace ClientInductionAPI.Models.CIModel
{
    ...
    [Index(nameof(Guid), nameof(Objectversionno), Name = "DOCUMENTTYPEMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_DOCUMENTTYPEMAS_PK", IsUnique = true)]
