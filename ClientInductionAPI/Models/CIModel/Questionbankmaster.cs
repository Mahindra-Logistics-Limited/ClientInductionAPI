...
{
    [Keyless]
    [Table("QUESTIONBANKMASTER")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "QUESTIONBANKMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_QUESTIONBANKMAS_PK", IsUnique = true)]
    public partial class Questionbankmaster
    {
        ...
        [Required]
        [Column("INSPECTIONCATEGORYMASTERGUID")]
        [StringLength(36)]
        public string Inspectioncategorymasterguid { get; set; }
        ...
        [Column("QUESTIONSERIALNO")]
        public short? Questionserialno { get; set; }
    }
}
