...
namespace ClientInductionAPI.Models.CIModel
{
    [Keyless]
    [Table("CARDOCS")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "CARDOCS_GUID_OVN", IsUnique = true)]
    [Index(nameof(Carmasterguid), Name = "XMERU_CARDOCS_CAR")]
    [Index(nameof(Pkguid), Name = "XMERU_CARDOCS_PKGUID", IsUnique = true)]
    public partial class Cardoc
    {
        [Required]
        [Column("GUID")]
        [StringLength(36)]
