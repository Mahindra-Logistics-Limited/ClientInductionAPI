...
{
    [Table("CARDEVICEMAKEMASTER")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "CARDEVICEMAKEMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_CARDEVICEMAKEMAS_PK", IsUnique = true)]
    public partial class Cardevicemakemaster
    {
        [Key]
        [Column("GUID")]
        [StringLength(36)]
