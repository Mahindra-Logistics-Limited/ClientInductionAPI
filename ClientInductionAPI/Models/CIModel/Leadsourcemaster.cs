...
namespace ClientInductionAPI.Models.CIModel
{
    ...
    [Index(nameof(Guid), nameof(Objectversionno), Name = "LEADSOURCEMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_LEADSOURCEMASTER_PKGUID", IsUnique = true)]
