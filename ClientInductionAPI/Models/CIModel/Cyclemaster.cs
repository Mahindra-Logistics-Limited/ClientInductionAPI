...
namespace ClientInductionAPI.Models.CIModel
{
    [Keyless]
    [Table("CYCLEMASTER")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "CYCLEMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_CYCLEMASTER_PKGUID", IsUnique = true)]
    public partial class Cyclemaster
    {
        ...
        [Column("CYCLEDURATION", TypeName = "NUMBER")]
