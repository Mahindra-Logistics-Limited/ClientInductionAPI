...
{
    [Keyless]
    [Table("TRANSACTIONMASTER_06_04_2023")]
    [Index(nameof(Immediatepaytermflag), Name = "TXN_MASTER_IMM_PAY_FLAG")]
    [Index(nameof(Pkguid), Name = "XMERU_TRANSACTIONMASTER_PKGUID", IsUnique = true)]
    [Index(nameof(Securitycombinationguid), Name = "XMERU_TXN_SEC")]
    public partial class Transactionmaster06042023
    {
