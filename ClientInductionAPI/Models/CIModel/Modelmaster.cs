...
namespace ClientInductionAPI.Models.CIModel
{
    [Keyless]
    [Table("MODELMASTER")]
    [Index(nameof(Guid), nameof(Objectversionno), Name = "MODELMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_MODELMASTER_PKGUID", IsUnique = true)]
    [Index(nameof(Name), Name = "XMERU_MODEL_NAME", IsUnique = true)]
