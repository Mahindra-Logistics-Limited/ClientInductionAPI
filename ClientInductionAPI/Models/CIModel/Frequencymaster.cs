...
namespace ClientInductionAPI.Models.CIModel
{
    ...
    [Index(nameof(Guid), nameof(Objectversionno), Name = "FREQUENCYMASTER_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_FREQUENCYMASTER_PKGUID", IsUnique = true)]
