...
namespace ClientInductionAPI.Models.CIModel
{
    ...
    [Index(nameof(Guid), nameof(Objectversionno), Name = "TRANSACTIONSOURCE_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_TRANSACTIONSOURCE_PKGUID", IsUnique = true)]
