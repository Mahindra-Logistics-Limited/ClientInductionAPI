...
{
    [Table("DOB_DOC_BRAND_MAPPING")]
    public partial class DobDocBrandMapping
    {
        [Key]
        [Column("GUID")]
        [StringLength(36)]
        ...
        [InverseProperty(nameof(Brandmaster.DobDocBrandMappings))]
        public virtual Brandmaster Brandmastergu { get; set; }
        [ForeignKey(nameof(Documenttypeentityguid))]
        [InverseProperty(nameof(Documenttypeentity.DobDocBrandMappings))]
