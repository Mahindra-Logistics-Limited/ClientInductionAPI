...
{
    [Table("SALES_DOCUMENTS_INTERFACE")]
    public partial class SalesDocumentsInterface
    {
        [Key]
        [Column("GUID")]
        [StringLength(36)]
        ...
        [Column("AADHARCARDMATCH", TypeName = "NUMBER")]
        public decimal? Aadharcardmatch { get; set; }
    }
}
