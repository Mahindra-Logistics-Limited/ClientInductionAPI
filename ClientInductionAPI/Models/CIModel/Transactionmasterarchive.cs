...
{
    [Keyless]
    [Table("TRANSACTIONMASTERARCHIVE")]
    [Index(nameof(Immediatepaytermflag), Name = "TXN_MASTER_IMM_PAY_FLAG1")]
    [Index(nameof(Pkguid), Name = "XMERU_TRANSARCHIVE_PKGUID1", IsUnique = true)]
    [Index(nameof(Securitycombinationguid), Name = "XMERU_TXN_SEC1")]
    public partial class Transactionmasterarchive
    {
