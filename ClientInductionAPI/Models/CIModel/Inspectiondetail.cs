...
namespace ClientInductionAPI.Models.CIModel
{
    ...
    [Index(nameof(Guid), nameof(Objectversionno), Name = "INSPECTIONDETAILS_GUID_OVN", IsUnique = true)]
    [Index(nameof(Pkguid), Name = "XMERU_INSPECTIONDETAILS_PKGUID", IsUnique = true)]
    public partial class Inspectiondetail
    {
        ...
        [Required]
        [Column("INSPECTIONRESULTSGUID")]
        [StringLength(36)]
        public string Inspectionresultsguid { get; set; }
        [Column("DESCRIPTION")]
        [StringLength(2000)]
