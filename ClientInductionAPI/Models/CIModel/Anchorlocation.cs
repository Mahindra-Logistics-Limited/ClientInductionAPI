...
{
    [Keyless]
    [Table("ANCHORLOCATION")]
    public partial class Anchorlocation
    {
        [Column("GUID")]
        [StringLength(36)]
        ...
        [Column("LATITUDE", TypeName = "NUMBER(13,10)")]
        public decimal? Latitude { get; set; }
        [Column("LONGITUDE", TypeName = "NUMBER(13,10)")]
        public decimal? Longitude { get; set; }
        [Column("RADIUS", TypeName = "NUMBER(4,2)")]
